...
<link rel="stylesheet" type="text/css" href="<%=cp%>/resources/styles/about.css">
<link rel="stylesheet" type="text/css" href="<%=cp%>/resources/styles/about_responsive.css">
</head>
<body>
...
<div class="super_container">
					...
					<div class="header_content d-flex flex-row align-items-center justify-content-start">
						...
						<nav class="main_nav">
							<ul>
								...
								<li class="active"><a href="<%=cp%>/about">About us</a></li>
	...
	<div class="home">
		<div class="parallax_background parallax-window" data-parallax="scroll" data-image-src="<%=cp%>/resources/images/about.jpg" data-speed="0.8"></div>
	...
	<div class="about">
		<div class="container">
			<div class="row">
				...
				<!-- About Image -->
				<div class="col-lg-6">
					<div class="about_image"><img src="<%=cp%>/resources/images/about_image.jpg" alt=""></div>
				</div>
			</div>
			...
			<div class="row realtors_row">
				...
				<div class="col-lg-3 col-md-6">
					<div class="realtor_outer">
						<div class="realtor">
							<div class="realtor_image"><img src="<%=cp%>/resources/images/realtor_1.jpg" alt=""></div>
				...
				<div class="col-lg-3 col-md-6">
					<div class="realtor_outer">
						<div class="realtor">
							<div class="realtor_image"><img src="<%=cp%>/resources/images/realtor_2.jpg" alt=""></div>
							<div class="realtor_body">
				...
				<div class="col-lg-3 col-md-6">
					<div class="realtor_outer">
						<div class="realtor">
							<div class="realtor_image"><img src="<%=cp%>/resources/images/realtor_3.jpg" alt=""></div>
							<div class="realtor_body">
				...
				<div class="col-lg-3 col-md-6">
					<div class="realtor_outer">
						<div class="realtor">
							<div class="realtor_image"><img src="<%=cp%>/resources/images/realtor_4.jpg" alt=""></div>
							<div class="realtor_body">
