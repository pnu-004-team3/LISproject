...
<link rel="stylesheet" type="text/css" href="<%=cp%>/resources/styles/contact.css">
<link rel="stylesheet" type="text/css" href="<%=cp%>/resources/styles/contact_responsive.css">
</head>
<body>
...
<div class="super_container">
	...
	<div class="home">
		<div class="parallax_background parallax-window" data-parallax="scroll" data-image-src="<%=cp%>/resources/images/contact.jpg" data-speed="0.8"></div>
...
<script src="<%=cp%>/resources/js/contact.js"></script>
</body>
</html>