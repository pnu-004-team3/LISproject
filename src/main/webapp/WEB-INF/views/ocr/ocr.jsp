...
<head>
    ...
    <link rel="stylesheet" href="<%=cp%>/resources/OCR/css/bootstrap.min.css"/>
    <link rel="stylesheet" href="<%=cp%>/resources/OCR/css/jquery.Jcrop.min.css"/>
...
<div class="container">
    ...
    <div class="row marketing">
        <div class="col-lg-6">
            ...
            <p><a href="https://github.com/evanw/glfx.js/">glfx.js</a> was used for image effects (sharpening, contrast,
                etc.). Cropping functionality (with touch support) is provided by jQuery plugin <a
                        href="<%=cp%>https://github.com/tapmodo/Jcrop">Jcrop</a>.</p>
            ...
            <p>I've made two short videos about this project: <a href="<%=cp%>https://www.youtube.com/watch?v=9TzXcBBC1J8">one that describes how this was built</a> and <a href="<%=cp%>https://www.youtube.com/watch?v=ttn437BlEbo">the other one that demonstrates how it works</a>. Hopefully, the source code is also quite readable.</p>
        </div>
        ...
        <div class="col-lg-6">
            ...
            <p>This demo is open source, and is hosted on <a href="<%=cp%>https://github.com/kdzwinel/JS-OCR-demo">GitHub</a>.
