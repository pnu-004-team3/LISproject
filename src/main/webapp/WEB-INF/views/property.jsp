...
<link rel="stylesheet" type="text/css" href="<%=cp%>/resources/styles/property.css">
<link rel="stylesheet" type="text/css" href="<%=cp%>/resources/styles/property_responsive.css">
</head>
<body>
...
<div class="super_container">
	...
	<div class="menu trans_500">
		<div class="menu_content d-flex flex-column align-items-center justify-content-center text-center">
			...
			<ul>
				<li class="menu_item"><a href="<%=cp%>/resources/index.jsp">Home</a></li>
				<li class="menu_item"><a href="<%=cp%>/resources/about.jsp">About us</a></li>
				<li class="menu_item"><a href="<%=cp%>/resources/#">Speakers</a></li>
				<li class="menu_item"><a href="<%=cp%>/resources/#">Tickets</a></li>
				<li class="menu_item"><a href="<%=cp%>/resources/news.jsp">News</a></li>
				<li class="menu_item"><a href="<%=cp%>/resources/contact.jsp">Contact</a></li>
			</ul>
		</div>
	...
	<div class="intro">
					...
					<div class="intro_content d-flex flex-lg-row flex-column align-items-start justify-content-start">
						<div class="intro_title_container">
							...
							<div class="intro_tags">
								<ul>
									<li><a href="<%=cp%>/resources/#">Hottub</a></li>
									<li><a href="<%=cp%>/resources/#">Swimming Pool</a></li>
									<li><a href="<%=cp%>/resources/#">Garden</a></li>
									<li><a href="<%=cp%>/resources/#">Patio</a></li>
									<li><a href="<%=cp%>/resources/#">Hard Wood Floor</a></li>
								</ul>
							</div>
						</div>
		...
		<div class="intro_slider_container">
			...
			<div class="owl-carousel owl-theme intro_slider">
				<!-- Slide -->
				<div class="owl-item"><img src="<%=cp%>/resources/images/intro_1.jpg" alt=""></div>
				<!-- Slide -->
				<div class="owl-item"><img src="<%=cp%>/resources/images/intro_1.jpg" alt=""></div>
				<!-- Slide -->
				<div class="owl-item"><img src="<%=cp%>/resources/images/intro_1.jpg" alt=""></div>
				...
				<div class="col-lg-4">
					<div class="sidebar">
						...
						<div class="sidebar_realtor">
							<div class="sidebar_realtor_image"><img src="<%=cp%>/resources/images/sidebar_realtor.jpg" alt=""></div>
							<div class="sidebar_realtor_body text-center">
								<div class="sidebar_realtor_title"><a href="<%=cp%>/resources/#">Maria Williams</a></div>
								...
								<div class="realtor_link"><a href="<%=cp%>/resources/#">+</a></div>
							</div>
						</div>
					</div>
				</div>
							...
							<div class="property_rooms d-flex flex-sm-row flex-column align-items-start justify-content-start">
								...
								<div class="property_room">
									...
									<div class="property_room_content d-flex flex-row align-items-center justify-content-start">
										<div class="room_icon"><img src="<%=cp%>/resources/images/room_1.png" alt=""></div>
								...
								<div class="property_room">
									...
									<div class="property_room_content d-flex flex-row align-items-center justify-content-start">
										<div class="room_icon"><img src="<%=cp%>/resources/images/room_2.png" alt=""></div>
								...
								<div class="property_room">
									...
									<div class="property_room_content d-flex flex-row align-items-center justify-content-start">
										<div class="room_icon"><img src="<%=cp%>/resources/images/room_3.png" alt=""></div>
								...
								<div class="property_room">
									...
									<div class="property_room_content d-flex flex-row align-items-center justify-content-start">
										<div class="room_icon"><img src="<%=cp%>/resources/images/room_4.png" alt=""></div>
								...
								<div class="property_room">
									...
									<div class="property_room_content d-flex flex-row align-items-center justify-content-start">
										<div class="room_icon"><img src="<%=cp%>/resources/images/room_5.png" alt=""></div>
...
<script src="<%=cp%>/resources/https://maps.googleapis.com/maps/api/js?v=3.exp&key=AIzaSyCIwF204lFZg1y4kPSIhKaHEXMLYxxuMhA"></script>
<script src="<%=cp%>/resources/js/property.js"></script>
</body>
</html>