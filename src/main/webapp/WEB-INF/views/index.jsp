...
<div class="super_container">
	...
	<div class="home">
		...
		<div class="home_slider_container">
			<div class="owl-carousel owl-theme home_slider">
				...
				<!-- Slide -->
				<div class="owl-item">
					<div class="home_slider_background" style="background-image:url(<%=cp%>/resources/images/home_slider_1.jpg)"></div>
									...
									<div class="slide_content">
										...
										<div class="home_details">
											<ul class="home_details_list d-flex flex-row align-items-center justify-content-start">
												<li>
													<div class="home_details_image"><img src="<%=cp%>/resources/images/icon_1.png" alt=""></div>
													<span> 650 Ftsq</span>
												</li>
												<li>
													<div class="home_details_image"><img src="<%=cp%>/resources/images/icon_2.png" alt=""></div>
													<span> 3 Bedrooms</span>
												</li>
												<li>
													<div class="home_details_image"><img src="<%=cp%>/resources/images/icon_3.png" alt=""></div>
		...
		<div class="container">
			...
			<div class="row recent_row">
				<div class="col">
								...
								<div class="recent_item">
									<div class="recent_item_inner">
										<div class="recent_item_image">
											...
											<div class="tag_featured property_tag"><a href="<%=cp%>/#">Featured</a></div>
										</div>
										<div class="recent_item_body text-center">
											<div class="recent_item_location">Miami</div>
											<div class="recent_item_title"><a href="<%=cp%>/property">Sea view property</a></div>
										...
										<div class="recent_item_footer d-flex flex-row align-items-center justify-content-start">
											<div><div class="recent_icon"><img src="<%=cp%>/resources/images/icon_1.png" alt=""></div><span>650 Ftsq</span></div>
											<div><div class="recent_icon"><img src="<%=cp%>/resources/images/icon_2.png" alt=""></div><span>3 Bedrooms</span></div>
											<div><div class="recent_icon"><img src="<%=cp%>/resources/images/icon_3.png" alt=""></div><span>3 Bathrooms</span></div>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="recent_item">
									<div class="recent_item_inner">
										<div class="recent_item_image">
											...
											<div class="tag_offer property_tag"><a href="<%=cp%>/#">Offer</a></div>
										</div>
										<div class="recent_item_body text-center">
											<div class="recent_item_location">Los Angeles</div>
											<div class="recent_item_title"><a href="<%=cp%>/property">2 Floor Town House</a></div>
											<div class="recent_item_price">$ 1. 234 981</div>
										</div>
										<div class="recent_item_footer d-flex flex-row align-items-center justify-content-start">
											<div><div class="recent_icon"><img src="<%=cp%>/resources/images/icon_1.png" alt=""></div><span>650 Ftsq</span></div>
								...
								<div class="recent_item">
									<div class="recent_item_inner">
										...
										<div class="recent_item_body text-center">
											...
											<div class="recent_item_title"><a href="<%=cp%>/property">Vacation Home</a></div>
											<div class="recent_item_price">$ 1. 234 981</div>
										</div>
										<div class="recent_item_footer d-flex flex-row align-items-center justify-content-start">
											<div><div class="recent_icon"><img src="<%=cp%>/resources/images/icon_1.png" alt=""></div><span>650 Ftsq</span></div>
					...
					<div class="button recent_button"><a href="<%=cp%>/#">see more</a></div>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="cities">
		...
		<div class="cities_container d-flex flex-row flex-wrap align-items-start justify-content-between">
			...
			<!-- City -->
			<div class="city">
				<img src="<%=cp%>/resources/images/city_1.jpg" alt="https://unsplash.com/@dnevozhai">
				<div class="city_overlay">
					<a href="<%=cp%>/#" class="d-flex flex-column align-items-center justify-content-center">
			...
			<!-- City -->
			<div class="city">
				<img src="<%=cp%>/resources/images/city_2.jpg" alt="https://unsplash.com/@lachlanjdempsey">
				<div class="city_overlay">
					<a href="<%=cp%>/#" class="d-flex flex-column align-items-center justify-content-center">
						<div class="city_title">Ibiza Town</div>
						<div class="city_subtitle">Rentals from $450/month</div>
			...
			<!-- City -->
			<div class="city">
				<img src="<%=cp%>/resources/images/city_3.jpg" alt="https://unsplash.com/@hellolightbulb">
				<div class="city_overlay">
					<a href="<%=cp%>/#" class="d-flex flex-column align-items-center justify-content-center">
						<div class="city_title">Ibiza Town</div>
						<div class="city_subtitle">Rentals from $450/month</div>
			...
			<!-- City -->
			<div class="city">
				<img src="<%=cp%>/resources/images/city_4.jpg" alt="https://unsplash.com/@justinbissonbeck">
				<div class="city_overlay">
					<a href="<%=cp%>/#" class="d-flex flex-column align-items-center justify-content-center">
						<div class="city_title">Ibiza Town</div>
						<div class="city_subtitle">Rentals from $450/month</div>
			...
			<!-- City -->
			<div class="city">
				<img src="<%=cp%>/resources/images/city_5.jpg" alt="https://unsplash.com/@claudiotrigueros">
				<div class="city_overlay">
					<a href="<%=cp%>/#" class="d-flex flex-column align-items-center justify-content-center">
						<div class="city_title">Ibiza Town</div>
						<div class="city_subtitle">Rentals from $450/month</div>
			...
			<!-- City -->
			<div class="city">
				<img src="<%=cp%>/resources/images/city_6.jpg" alt="https://unsplash.com/@andersjilden">
				<div class="city_overlay">
					<a href="<%=cp%>/#" class="d-flex flex-column align-items-center justify-content-center">
						<div class="city_title">Ibiza Town</div>
						<div class="city_subtitle">Rentals from $450/month</div>
			...
			<!-- City -->
			<div class="city">
				<img src="<%=cp%>/resources/images/city_7.jpg" alt="https://unsplash.com/@sawyerbengtson">
				<div class="city_overlay">
					<a href="<%=cp%>/#" class="d-flex flex-column align-items-center justify-content-center">
						<div class="city_title">Ibiza Town</div>
						<div class="city_subtitle">Rentals from $450/month</div>
			...
			<!-- City -->
			<div class="city">
				<img src="<%=cp%>/resources/images/city_8.jpg" alt="https://unsplash.com/@mathewwaters">
				<div class="city_overlay">
					<a href="<%=cp%>/#" class="d-flex flex-column align-items-center justify-content-center">
						<div class="city_title">Ibiza Town</div>
						<div class="city_subtitle">Rentals from $450/month</div>
			...
			<div class="row testimonials_row">
				...
				<div class="col-lg-4 testimonial_col">
					<div class="testimonial">
						...
						<div class="testimonial_author_image"><img src="<%=cp%>/resources/images/testimonial_1.jpg" alt=""></div>
						<div class="testimonial_author"><a href="<%=cp%>/#">Diane Smith</a><span>, Client</span></div>
				...
				<div class="col-lg-4 testimonial_col">
					<div class="testimonial">
						...
						<div class="testimonial_author_image"><img src="<%=cp%>/resources/images/testimonial_2.jpg" alt=""></div>
						<div class="testimonial_author"><a href="<%=cp%>/#">Michael Duncan</a><span>, Client</span></div>
						<div class="rating_r rating_r_5 testimonial_rating"><i></i><i></i><i></i><i></i><i></i></div>
					</div>
				</div>
				...
				<div class="col-lg-4 testimonial_col">
					<div class="testimonial">
						...
						<div class="testimonial_author_image"><img src="<%=cp%>/resources/images/testimonial_3.jpg" alt=""></div>
						<div class="testimonial_author"><a href="<%=cp%>/#">Shawn Gaines</a><span>, Client</span></div>
						<div class="rating_r rating_r_5 testimonial_rating"><i></i><i></i><i></i><i></i><i></i></div>
					</div>
				</div>
