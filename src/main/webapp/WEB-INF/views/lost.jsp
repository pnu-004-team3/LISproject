					...
					<div id="divHeadScroll">
						...
						<tbody>
							<tr>
								...
								<td class="title">분실일</td>
								<td class="title">처리일</td>
								<td class="title">처리내용</td>
								<td></td>
							</tr>
						</tbody>
					</table>
						...
						<colgroup>
							...
							<c:forEach items="${borrowedList}" var="borrowed">
								<tr>
									...
									<td class="content right_border">${borrowed.Borrowed_Date}</td>
									<td class="content right_border">${borrowed.Return_Date}</td>
									<td class="content right_border">${borrowed.Overdue_Status}</td>
								</tr>
								<tr>
									...
									<td class="content right_border">중앙도서관</td>
									<td class="content right_border">${borrowed.Borrowed_Date}</td>
									<td class="content right_border">${borrowed.Return_Scheduled_Date}</td>
									<td class="content right_border">${borrowed.Overdue_Status}</td>
								</tr>
								<tr>
