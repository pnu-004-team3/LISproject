...
<link rel="stylesheet" type="text/css" href="<%=cp%>/resources/styles/elements.css">
<link rel="stylesheet" type="text/css" href="<%=cp%>/resources/styles/elements_responsive.css">
</head>
<body>
...
<div class="super_container">
	...
	<div class="home">
		<div class="parallax_background parallax-window" data-parallax="scroll" data-image-src="<%=cp%>/resources/images/elements.jpg" data-speed="0.8"></div>
				...
				<div class="col">
					...
					<div class="buttons">
						...
						<div class="buttons_container">
							<div class="button button_1"><a href="<%=cp%>/resources/#">send</a></div>
							<div class="button button_2"><a href="<%=cp%>/resources/#">send</a></div>
							<div class="button button_3"><div><a href="<%=cp%>/resources/#">send</a></div></div>
						</div>
					</div>
					...
					<div class="icon_boxes">
						...
						<div class="row icon_boxes_row">
							...
							<div class="col-lg-4 icon_box_col">
								<div class="icon_box">
									<div class="icon_box_title_container d-flex flex-row align-items-center justify-content-start">
										<div class="icon_box_icon d-flex flex-column align-items-center justify-content-center"><img src="<%=cp%>/resources/images/icon_4.png" alt=""></div>
							...
							<div class="col-lg-4 icon_box_col">
								<div class="icon_box">
									<div class="icon_box_title_container d-flex flex-row align-items-center justify-content-start">
										<div class="icon_box_icon"><img src="<%=cp%>/resources/images/icon_5.png" alt=""></div>
							...
							<div class="col-lg-4 icon_box_col">
								<div class="icon_box">
									<div class="icon_box_title_container d-flex flex-row align-items-center justify-content-start">
										<div class="icon_box_icon"><img src="<%=cp%>/resources/images/icon_6.png" alt=""></div>
...
<script src="<%=cp%>/resources/plugins/jquery-circle-progress-1.2.2/circle-progress.js"></script>
...
<script src="<%=cp%>/resources/js/elements.js"></script>
</body>
</html>